...
it. It is a single portable executable. The binary is not code-signed, so
Windows may show a SmartScreen prompt on first launch; the release page lists
the SHA-256 digest of each asset.
