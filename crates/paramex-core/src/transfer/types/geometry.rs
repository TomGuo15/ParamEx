...
/// Where a file's W/L came from. Historical report fixtures may still carry
/// strings other than the three live sources; those stay as [`Self::Other`].
...
pub enum GeometrySource {
    ...
    Manual,
    /// A preserved historical or imported label.
    Other(String),
}
