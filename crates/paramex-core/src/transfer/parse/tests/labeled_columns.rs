use crate::transfer::parse::labels::parse_labeled_columns;
...
// parser and Rust `from_str` can diverge by ≤1 ULP). Structure (lengths, names)
// stays exact.
const RTOL: f64 = 1e-12;
const ATOL: f64 = 0.0;

#[test]
fn parse_labeled_columns_matches_reference() {
    let reference = load_reference_in("parse", "labeled_columns");
